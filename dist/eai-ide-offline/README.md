...
chmod +x scripts/pack_offline_deploy.sh
./scripts/pack_offline_deploy.sh
```
...
```bash
chmod +x scripts/verify_release_image.sh
./scripts/verify_release_image.sh eai-ide:local
```

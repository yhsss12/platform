"""V2-B5.2 contact-aware rollout（asymmetric grasp refiner）。"""
...
from lift_v2b52_refiner import LiftV2B52Params, build_lift_v2b52_waypoints_from_hdf5
...
def execute_lift_v2b52_rollout(
    hdf5_path: str,
    demo_key: str,
    label: str,
    params: LiftV2B52Params,
    *,
    rollout_kind: str = "lift_v2b52_cem",
    ...
    for step in range(length):
        ...
        # reuse B5.1 overlay via compatible param view
    ...
    result: dict[str, Any] = {
        ...
        "lift_v2b51_params": {k: getattr(params, k) for k in params.__dataclass_fields__ if hasattr(params, k)},

#!/usr/bin/env python3
"""
Train a coffee_preparation repair-parameter residual-field PINN from feedback rollouts
...
from phygen.adapters.mimicgen.coffee_repair import demo_sort_key, load_failed_contexts, make_candidate

                                                   ...
                                                   const rs2::stream_profile& base_profile)
{
    ...
    bool special_stream = false;
    #ifdef RS_HAS_STREAM_LABELED_POINT_CLOUD
    special_stream = special_stream || (profile.stream_type() == RS2_STREAM_LABELED_POINT_CLOUD);
    #endif
    #ifdef RS_HAS_STREAM_OCCUPANCY
    special_stream = special_stream || (profile.stream_type() == RS2_STREAM_OCCUPANCY);
    #endif
    if(special_stream)
    {

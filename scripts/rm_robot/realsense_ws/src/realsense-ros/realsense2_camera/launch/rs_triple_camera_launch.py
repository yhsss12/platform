...
# DESCRIPTION #
# ----------- #
# Use this launch file to launch 3 devices.
...
# ros2 launch realsense2_camera rs_triple_camera_launch.py camera_name1:=D400 device_type2:=l5. device_type1:=d4..
...
def launch_static_transform_publisher_node(context : LaunchContext):
    ...
    node2 = node_action(
            namespace="",
            name="tf2_static_transform_publisher_1_2",
            package = "tf2_ros",
    ...
    node3 = node_action(
            namespace="",
            name="tf2_static_transform_publisher_1_3",
            package = "tf2_ros",
            executable = "static_transform_publisher",
            arguments = ["0", "0", "0", "0", "0", "0",
                          context.launch_configurations['camera_name1'] + "_link",

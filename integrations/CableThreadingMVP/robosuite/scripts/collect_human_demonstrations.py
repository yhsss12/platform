...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="rmb",
        help="Cable model to use for CableStraighten / cable tasks. Ignored by non-cable environments.",
    )
    parser.add_argument(
        "--robots",
        nargs="+",
    ...
    if args.environment == "CableStraighten":
        config["cable_model"] = args.cable_model
